        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_titulo_helper_text" sx={{marginLeft: 0}}>Título da Tarefa.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text" sx={{marginLeft: 0}}>Descrição da Tarefa.</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_recurso" sx={{mt: 1}}>Recurso</InputLabel>
                <Select
                  id="tarefa_recurso"
                  value={recursoTarefa}
                  label="Recurso"
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_recurso" sx={{mt: 1}}>Status</InputLabel>
                <Select
                  id="tarefa_status"
                  value={statusTarefa}
                  label="Status"
